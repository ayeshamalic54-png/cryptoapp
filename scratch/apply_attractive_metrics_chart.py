...
# Define the new custom tooltip component and updated styles
new_code = """import { useGetMetrics, useGetMetricsSummary, getGetMetricsQueryKey, getGetMetricsSummaryQueryKey } from "@workspace/api-client-react";
...
print("metrics.tsx updated successfully with gorgeous gradients, premium fonts/spacings, and responsive custom tooltips.")

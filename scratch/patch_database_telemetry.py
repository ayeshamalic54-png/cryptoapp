...
# We find the old function signature
old_fn_start = "def update_bot_state("
# Let's find the end of it (where the next def starts, e.g. def update_daily_metrics)
next_def = "def update_daily_metrics"
...
if start_idx != -1 and end_idx != -1:
    ...
    print("database.py updated with robust overall drawdown and new account auto-reset logic.")
else:
